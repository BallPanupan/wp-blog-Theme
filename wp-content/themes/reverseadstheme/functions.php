<?php
    ...
    function register_styles() {
        ...
        wp_enqueue_style('style', get_template_directory_uri() . "/theme-tamplate/css/style.css", array(), $version, 'all');
    ...
    function register_script(){
        ...
        wp_enqueue_script('javascript', get_template_directory_uri() . '/theme-tamplate/js/main.js', array(), '3.4.1', true);
    }
